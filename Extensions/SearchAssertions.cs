...
{
    /// <summary>
    /// SearchAssertions - where the <see cref="IAssertableQueue{TData}"/> is enumerated without removing elements for assertions
    /// </summary>
    /// <typeparam name="TData">Type of Element</typeparam>
    public class SearchAssertions<TData>
    {
        internal SearchAssertions(IAssertableQueue<TData> assertableQueue, string callerExp = null)
        {
        ...
        /// <summary>
        /// Searches the collection without removing elements until it finds <paramref name="expectedData"/>.
        ...
        /// <summary>
        /// Searches the collection (without removing elements) and enumerates each element until the <paramref name="matchingCondition"/> satisifies.
        /// </summary>
